...
public class AddNotification extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Thêm thông báo");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 10, 220, 40));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 90, 440, 200));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 310, 110, 35));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(noiDung.equals(""))
        {
            JOptionPane.showMessageDialog(rootPane, "Thông báo phải có nội dung");
        }
        else{
